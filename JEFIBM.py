...
#This emulator is only to be used as an example as 'Just Enough For IBM' - for a better full CHIP-8 emulator try my HSF8, https://github.com/0xilis/HSF8/blob/main/emu.py
from tkinter import *
import math
import time
import random
